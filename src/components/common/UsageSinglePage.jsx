...
export const UsageSinglePage = () => {
  return (
    <div>
      <section className='py-12'>
        <div className='w-3/5 md:w-4/5 m-auto shadow-md rounded-lg'>
          <img className='w-full rounded-t-lg' src='https://bdevs.net/wp/educal/wp-content/uploads/2021/08/usage-1.jpg' alt='' />
          ...
          <img className='w-full' src='https://bdevs.net/wp/educal/wp-content/uploads/2021/08/usage-3.jpg' alt='' />
          <div className='text p-5'>
